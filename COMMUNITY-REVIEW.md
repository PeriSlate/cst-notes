...
The private source repository includes a deterministic build script and release verification checks. The source output, the private build output, and the public `main.js` are byte-for-byte identical for v0.1.7.
...
3. Create the v0.1.7 public GitHub Release and attach `main.js`, `manifest.json`, and `styles.css`.
